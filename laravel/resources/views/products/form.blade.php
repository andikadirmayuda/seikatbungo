        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-8 form-enter">
                ...
                <h2 class="text-3xl font-bold text-gray-800 mb-2">
                    {{ isset($product) ? 'Edit' : 'Tambah' }} <span class="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-rose-600">Produk</span>
                </h2>
                <p class="text-gray-600">{{ isset($product) ? 'Perbarui informasi produk dengan lengkap' : 'Lengkapi informasi produk dengan detail' }}</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="category_id" id="category_id" 
                                    class="w-full px-4 py-3 border border-pink-200 rounded-xl input-focus focus:outline-none" required>
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Opsional - sistem akan generate otomatis jika kosong</p>
                        </div>
                ...
                <div class="section-card p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Peringatan akan muncul jika stok di bawah nilai ini</p>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center">
                                                <div class="w-3 h-3 bg-gradient-to-r from-pink-400 to-rose-500 rounded-full mr-3"></div>
                                                <span class="font-medium text-gray-800">{{ ucwords(str_replace('_', ' ', $type)) }}</span>
                                            </div>
