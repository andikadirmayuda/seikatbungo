...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="Struk penjualan {{ $sale->order_number }} dari Seikat Bungo">
    <meta property="og:title" content="Struk Digital - {{ $sale->order_number }}">
    <meta property="og:description" content="Bukti penjualan dari Seikat Bungo">
