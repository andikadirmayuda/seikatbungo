...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE product_prices MODIFY COLUMN type ENUM('per_tangkai','ikat_3','ikat_5','ikat_10','ikat_20','reseller','normal','promo','harga_grosir','custom_ikat','custom_tangkai','custom_khusus')");
    }
